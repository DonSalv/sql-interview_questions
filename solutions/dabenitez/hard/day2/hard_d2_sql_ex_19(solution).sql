...
SELECT Q1.month, Q1.active_drivers, COALESCE(Q2.accepted_rides,0) AS accepted_rides FROM
...
LEFT JOIN
(SELECT EXTRACT(MONTH FROM r.requested_at) AS month, COUNT(ar.ride_id) AS accepted_rides
