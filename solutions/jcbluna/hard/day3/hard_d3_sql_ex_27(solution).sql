...
-- Solve the exercise
SELECT e.experience, COUNT(c.employee_id) AS accepted_candidates
FROM(SELECT employee_id, experience, salary, cum_salary
...
WHERE cum_salary<=70000) c RIGHT OUTER JOIN
(SELECT DISTINCT experience FROM Candidates) e
ON(e.experience=c.experience)
